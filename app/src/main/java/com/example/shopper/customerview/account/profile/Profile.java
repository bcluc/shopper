package com.example.shopper.customerview.account.profile;
...
public class Profile extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private final ActivityResultLauncher<PickVisualMediaRequest> launcher = registerForActivityResult(new ActivityResultContracts.PickVisualMedia(), new ActivityResultCallback<Uri>() {
        ...
        public void onActivityResult(Uri o) {
            if (o == null) {
                Toast.makeText(Profile.this, "No image was selected.", Toast.LENGTH_SHORT).show();
            } else {
                ...
                docRef.update(map)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                Toast.makeText(Profile.this, "Success updating the data", Toast.LENGTH_SHORT).show();
                                dialogPlus.dismiss();
                                try {
    ...
    private void updateImgInStorage(Uri imageUri) {
        ...
        imageRef.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(Profile.this, "Fail to send image to firebase", Toast.LENGTH_LONG).show();
                        // Tải ảnh thất bại
                    }
                });
