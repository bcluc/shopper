package com.example.shopper.staffview.viewshop.activity.detail.shop;
...
public class DetailShopView extends AppCompatActivity {
                ...
                FirebaseFirestore.getInstance().collection("REVIEW")
                        ...
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful() && !task.getResult().isEmpty()) {
                                ...
                                Intent intent = new Intent(DetailShopView.this, Reviewer.class);
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            // Cập nhật thành công
                                            Toast.makeText(DetailShopView.this, "Trending has been updated: " + String.valueOf(newTrangThai), Toast.LENGTH_SHORT).show();
                                        } else {
                                            // Cập nhật thất bại
                                            Toast.makeText(DetailShopView.this, "Trending update failed", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
