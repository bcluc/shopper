...
import com.example.shopper.staffview.product.activity.EditProductWithoutAmount;
...
public class MyInventoryAdapter extends RecyclerView.Adapter<MyInventoryAdapter.ProductsViewHolder> implements Filterable {
    ...
    public MyInventoryAdapter(List<Product> productList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ProductsViewHolder holder, int position) {
        ...
        holder.Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), EditProductWithoutAmount.class);
